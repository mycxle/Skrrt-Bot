...
class Security:
    def __init__(self, db):
        ...
        self.settings = {
            ...
            "join_roles": helpers.db_get(db, self.root+"/join_roles", is_list=True),
            ...
            "brodgod_role": helpers.db_get(db, self.root+"/brodgod_role"),
            "brod_role": helpers.db_get(db, self.root+"/brod_role"),
        ...
        self.restrictions = {
            ...
            "join_roles": [helpers.is_pos, "Positive integer"],
            ...
            "brod_role": [helpers.is_pos, "Positive integer"],
            "brodgod_role": [helpers.is_pos, "Positive integer"],
